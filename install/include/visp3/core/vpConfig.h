...
// ViSP version with dots "3.2.1".
#define VISP_VERSION 3.2.1
...
#  define VISP_HAVE_OPENCV_VERSION (4<<16 | 1<<8 | 1)
#endif
...
#define VISP_HAVE_LAPACK_BUILT_IN

// Defined the path to the basic scenes used by the simulator
#define VISP_SCENES_DIR "D:/visp-ws/visp-build-vc15/install/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "D:/visp-ws/visp-build-vc15/install/data/robot-simulator"
...
/* #undef VISP_HAVE_DC1394_CAMERA_ENUMERATE */
